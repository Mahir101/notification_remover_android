...
public class NotificationListAdapter extends RecyclerView.Adapter<NotificationListAdapter.ViewHolder> {
    ...
    private Consumer<NotificationItem> onLongPress;
    ...
    public void setOnLongPressListener(Consumer<NotificationItem> listener) {
        this.onLongPress = listener;
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        NotificationItem item = dataSource.getAllNotifications().get(position);
        viewHolder.update(item);
        viewHolder.view.setOnLongClickListener(v -> {
            if (onLongPress != null) {
                onLongPress.accept(item);
                return true;
            }
            return false;
        });
